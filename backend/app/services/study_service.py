...
def _study_row(study: Study, patient: Patient, latest: Report | None, *,
    ...
    row = {
        ...
        # 행잉 프로토콜 부위 매칭용 — 뷰어가 설정된 필드에서 부위 문자열을 찾는다
        "protocol_name": study.protocol_name or "",
        "procedure_code": study.procedure_code or "",
        "procedure_desc": study.procedure_desc or "",
        "step_desc": study.step_desc or "",
        "status": study.status,
