...
start "Saintview Landing (5173)" /min cmd /c "cd /d %~dp0frontend && npm run dev -- --port 5173 --strictPort > %TEMP%\sv_5173.log 2>&1"
start "Saintview Admin (5174)" /min cmd /c "cd /d %~dp0frontend && npm run dev -- --port 5174 --strictPort > %TEMP%\sv_5174.log 2>&1"
start "Saintview Client (5175)" /min cmd /c "cd /d %~dp0frontend && npm run dev -- --port 5175 --strictPort > %TEMP%\sv_5175.log 2>&1"
