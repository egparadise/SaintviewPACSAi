...
start "Saintview Landing (5173)" /min cmd /c "cd /d %~dp0frontend && set VITE_HTTPS=1 && npm run dev -- --host 0.0.0.0 --port 5173 --strictPort > %TEMP%\sv_5173.log 2>&1"
start "Saintview Admin (5174)" /min cmd /c "cd /d %~dp0frontend && set VITE_HTTPS=1 && npm run dev -- --host 0.0.0.0 --port 5174 --strictPort > %TEMP%\sv_5174.log 2>&1"
...
set /a _try=0
:wait_landing
curl -sk -o NUL -m 2 https://localhost:5173 >nul 2>&1 && goto open_landing
set /a _try+=1
