...
- [ ] 남은 것(차기): 측정/ROI 도구(Cornerstone 스택 경로 — setStack 후 무음정지 미해결, 단서: 디코드워커 기동까지 확인) · reference line · GSPS · 자동계측 CTR(S2) · 자연어검색(S1 nl_to_query) · report_merge UI · 패널 드래그 · Mode Profile 백엔드 JSON화(S7) · 음성 STT · MWL/MPPS · 번인 OCR
