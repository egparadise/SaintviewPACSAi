...
- [ ] 남은 것(차기): 측정/ROI 도구(Cornerstone 스택 경로 — setStack 후 무음정지 미해결, 단서: 디코드워커 기동까지 확인) · reference line · GSPS · 자동계측 CTR(S2) · 패널 드래그 · 외부 AI 결과 병합(F-12) · 음성 STT · MWL/MPPS · 번인 OCR
