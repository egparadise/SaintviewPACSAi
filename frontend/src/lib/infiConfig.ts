...
export const IN_PALETTE: { id: string; icon: string; label: string; impl: boolean; mode?: boolean; group: string }[] = [
  ...
  { id: "limb", icon: "🦵", label: "Limb Length — 선1(2점)+선2(2점) 길이 비교", impl: true, mode: true, group: "측정" },
  ...
  { id: "cobb", icon: "⟁", label: "Cobb Angle — 선1(2점)+선2(2점) 사이 각", impl: true, mode: true, group: "측정" },
